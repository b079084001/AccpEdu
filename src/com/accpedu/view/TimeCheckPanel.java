...
public class TimeCheckPanel extends JPanel implements ListSelectionListener{
    ...
    public TimeCheckPanel(ClassInfoBean classinfo) {
      try {
          jbInit();
    ...
    private void jbInit() throws Exception {
        ...
        jButton1.addActionListener(new TimeCheckPanel_jButton1_actionAdapter(this));
        ...
        inputButton.addActionListener(new
                                      TimeCheckPanel_inputButton_actionAdapter(this));
        ...
        jRadioButton1.addActionListener(new
                TimeCheckPanel_jRadioButton1_actionAdapter(this));
        jRadioButton2.setOpaque(false);
        jRadioButton2.setText("按学号查询");
        jRadioButton2.addActionListener(new
                TimeCheckPanel_jRadioButton2_actionAdapter(this));
        jButton3.setText("查询考勤");
        jButton3.addActionListener(new TimeCheckPanel_jButton3_actionAdapter(this));
        ...
        this.add(jRadioButton1, new XYConstraints(43, 338, 86, -1));
    ...
    public void initSelectByDate(){
        ...
        ArrayList list=timeCheckAction.getCheckTime(classinfo.getClassId());
...
class TimeCheckPanel_jRadioButton1_actionAdapter implements ActionListener {
    private TimeCheckPanel adaptee;
    TimeCheckPanel_jRadioButton1_actionAdapter(TimeCheckPanel adaptee) {
...
class TimeCheckPanel_inputButton_actionAdapter implements ActionListener {
    private TimeCheckPanel adaptee;
    TimeCheckPanel_inputButton_actionAdapter(TimeCheckPanel adaptee) {
        this.adaptee = adaptee;
    }
...
class TimeCheckPanel_jRadioButton2_actionAdapter implements ActionListener {
    private TimeCheckPanel adaptee;
    TimeCheckPanel_jRadioButton2_actionAdapter(TimeCheckPanel adaptee) {
        this.adaptee = adaptee;
    }
...
class TimeCheckPanel_jButton3_actionAdapter implements ActionListener {
    private TimeCheckPanel adaptee;
    TimeCheckPanel_jButton3_actionAdapter(TimeCheckPanel adaptee) {
        this.adaptee = adaptee;
    }
...
class TimeCheckPanel_jButton1_actionAdapter implements ActionListener {
    private TimeCheckPanel adaptee;
    TimeCheckPanel_jButton1_actionAdapter(TimeCheckPanel adaptee) {
        this.adaptee = adaptee;
    }
