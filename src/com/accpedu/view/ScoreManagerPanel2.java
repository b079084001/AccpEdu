...
public class ScoreManagerPanel2 extends JPanel  implements ListSelectionListener{
    ...
    public ScoreManagerPanel2(ClassInfoBean classinfo) {
        try {
            jbInit();
    ...
    private void jbInit() throws Exception {
        ...
        okButton.addActionListener(new ScoreManagerPanel2_okButton_actionAdapter(this));
        ...
        scoreInputButton.addActionListener(new
                ScoreManagerPanel2_scoreInputButton_actionAdapter(this));
        ...
        jRadioButton1.addActionListener(new
                ScoreManagerPanel2_jRadioButton1_actionAdapter(this));
        jLabel9.setText("科目:");
        jRadioButton2.setOpaque(false);
        jRadioButton2.setText("按学号查询成绩");
        jRadioButton2.addActionListener(new
                ScoreManagerPanel2_jRadioButton2_actionAdapter(this));
        jButton2.setText("开始查询");
        jButton2.addActionListener(new ScoreManagerPanel2_jButton2_actionAdapter(this));
        ...
        xYLayout1.setWidth(718);
        xYLayout1.setHeight(509);
        ...
        jPanel1.add(jButton2, new XYConstraints(511, 19, 97, -1));
    }
...
class ScoreManagerPanel2_jRadioButton2_actionAdapter implements ActionListener {
    private ScoreManagerPanel2 adaptee;
    ScoreManagerPanel2_jRadioButton2_actionAdapter(ScoreManagerPanel2 adaptee) {
...
class ScoreManagerPanel2_jRadioButton1_actionAdapter implements ActionListener {
    private ScoreManagerPanel2 adaptee;
    ScoreManagerPanel2_jRadioButton1_actionAdapter(ScoreManagerPanel2 adaptee) {
        this.adaptee = adaptee;
    }
...
class ScoreManagerPanel2_scoreInputButton_actionAdapter implements
        ActionListener {
    private ScoreManagerPanel2 adaptee;
    ScoreManagerPanel2_scoreInputButton_actionAdapter(ScoreManagerPanel2 adaptee) {
        this.adaptee = adaptee;
    }
...
class ScoreManagerPanel2_okButton_actionAdapter implements ActionListener {
    private ScoreManagerPanel2 adaptee;
    ScoreManagerPanel2_okButton_actionAdapter(ScoreManagerPanel2 adaptee) {
        this.adaptee = adaptee;
    }
...
class ScoreManagerPanel2_jButton2_actionAdapter implements ActionListener {
    private ScoreManagerPanel2 adaptee;
    ScoreManagerPanel2_jButton2_actionAdapter(ScoreManagerPanel2 adaptee) {
        this.adaptee = adaptee;
    }
