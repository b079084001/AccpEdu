...
public class ClassManagerFrame extends JFrame implements ListSelectionListener{
    ...
    ArchivesPanel archivesPanel=null;
    ScoreManagerPanel scoreManagerPanel=null;
    TimeCheckPanel timeCheckPanel=null;
    int flag=0;//0:班级信息;1:考勤管理;2:成绩管理;3:档案管理

    GridBagLayout gridBagLayout1 = new GridBagLayout();
    public ClassManagerFrame(UserInfoBean user) {
        try {
            jbInit();
    ...
    private void jbInit() throws Exception {
        ...
        jRadioButton1.setText("考勤管理");
        jRadioButton1.addActionListener(new
                ClassManagerFrame_jRadioButton1_actionAdapter(this));
        jRadioButton2.setOpaque(false);
        jRadioButton2.setText("成绩管理");
        jRadioButton2.addActionListener(new
                ClassManagerFrame_jRadioButton2_actionAdapter(this));
        jRadioButton3.setOpaque(false);
        jRadioButton3.setText("档案管理");
        jRadioButton3.addActionListener(new
                ClassManagerFrame_jRadioButton3_actionAdapter(this));
        ...
        modifystuButton.addActionListener(new
                ClassManagerFrame_modifystuButton_actionAdapter(this));
        ...
        exitmanageButton.addActionListener(new
                ClassManagerFrame_exitmanageButton_actionAdapter(this));
        classComboBox.setModel(classModel);
        classComboBox.addActionListener(new
                ClassManagerFrame_classComboBox_actionAdapter(this));
        ...
        classInfoButton.addActionListener(new
                ClassManagerFrame_classInfoButton_actionAdapter(this));
        ...
        jMenuItem1.addActionListener(new
                                     ClassManagerFrame_jMenuItem1_actionAdapter(this));
        ...
        jMenuFileExit.addActionListener(new
                                        ClassManagerFrame_jMenuFileExit_ActionAdapter(this));
        jMenuHelp.setText("帮助");
        jMenuHelpAbout.setText("关于");
        jMenuHelpAbout.addActionListener(new
                                         ClassManagerFrame_jMenuHelpAbout_ActionAdapter(this));
        ...
        jPanel1.add(jLabel4, new GridBagConstraints(1, 0, 1, 1, 0.0, 0.0
                ...
                new Insets(13, 41, 0, 28), 11, 11));
        jPanel1.add(jLabel2, new GridBagConstraints(0, 2, 1, 2, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(0, 35, 12, 0), 5, 12));
        jPanel1.add(jLabel1, new GridBagConstraints(0, 0, 1, 2, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(23, 67, 0, 23), 52, 8));
        jPanel1.add(jPanel2, new GridBagConstraints(3, 0, 1, 4, 1.0, 1.0
                , GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(13, 25, 0, 17), 51, 9));
        jPanel1.add(classComboBox, new GridBagConstraints(1, 1, 2, 2, 1.0, 0.0
                , GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                new Insets(0, 42, 0, 0), 42, -6));
        jPanel1.add(classInfoButton,
                    new GridBagConstraints(1, 3, 1, 1, 0.0, 0.0
                                           , GridBagConstraints.CENTER,
                                           GridBagConstraints.NONE,
                                           new Insets(6, 80, 0, 0), 13, -6));
        jPanel1.add(jLabel3, new GridBagConstraints(2, 4, 1, 1, 0.0, 0.0
                , GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(0, 9, 0, 10), 0, 0));
    }
    ...
    public void sayHello(){
        ...
        this.setTitle(userinfo.getUserId()+"班主任管理界面");
    ...
    public void setClassComboBox(){
        ...
        ClassInfoBean classinfo=null;
        classlist=classAction.findAllClass(this.userinfo);
        //填充下拉列表
        if(classlist!=null){
            ...
            System.out.println("error:ClassManagerFrame.setClassComboBox()");
        }
    }
    ...
    public void initClassTable(){
        ...
        if(classlist!=null){
            ...
            System.out.println("error:ClassManagerFrame.initClassTable()");
        }
    ...
    */
    ...
    public void jRadioButton3_actionPerformed(ActionEvent e) {
       ...
       this.archivesPanel = new ArchivesPanel(this.classInfo);
    ...
    public void jRadioButton2_actionPerformed(ActionEvent e) {
        if(classComboBox.getSelectedIndex()==0){
           JOptionPane.showMessageDialog(this,"请先在左边选择要管理的班级","警告",JOptionPane.INFORMATION_MESSAGE);
       ...
       this.scoreManagerPanel=new ScoreManagerPanel(this.classInfo);
       this.getContentPane().remove(oldPanel);
       this.classInfoButton.setEnabled(true);
    ...
    public void jRadioButton1_actionPerformed(ActionEvent e) {
       ...
       this.timeCheckPanel=new TimeCheckPanel(this.classInfo);
       this.getContentPane().remove(oldPanel);
       this.classInfoButton.setEnabled(true);
...
class ClassManagerFrame_jMenuItem1_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_jMenuItem1_actionAdapter(ClassManagerFrame adaptee) {
...
class ClassManagerFrame_modifystuButton_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_modifystuButton_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_classComboBox_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_classComboBox_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_jRadioButton2_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_jRadioButton2_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_jRadioButton1_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_jRadioButton1_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_classInfoButton_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_classInfoButton_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_jRadioButton3_actionAdapter implements ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_jRadioButton3_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_exitmanageButton_actionAdapter implements
        ActionListener {
    private ClassManagerFrame adaptee;
    ClassManagerFrame_exitmanageButton_actionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_jMenuFileExit_ActionAdapter implements ActionListener {
    ClassManagerFrame adaptee;

    ClassManagerFrame_jMenuFileExit_ActionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
...
class ClassManagerFrame_jMenuHelpAbout_ActionAdapter implements ActionListener {
    ClassManagerFrame adaptee;

    ClassManagerFrame_jMenuHelpAbout_ActionAdapter(ClassManagerFrame adaptee) {
        this.adaptee = adaptee;
    }
