...
public class ArchivesPanel2 extends JPanel implements ListSelectionListener{
    ...
    public ArchivesPanel2(ClassInfoBean classinfo) {
        try {
            jbInit();
...
class ArchivesPanel2_exitButton_actionAdapter implements ActionListener {
    private ArchivesPanel2 adaptee;
    ArchivesPanel2_exitButton_actionAdapter(ArchivesPanel2 adaptee) {
...
class ArchivesPanel2_jTextField2_actionAdapter implements ActionListener {
    private ArchivesPanel2 adaptee;
    ArchivesPanel2_jTextField2_actionAdapter(ArchivesPanel2 adaptee) {
        this.adaptee = adaptee;
    }
...
class ArchivesPanel2_jTextField1_actionAdapter implements ActionListener {
    private ArchivesPanel2 adaptee;
    ArchivesPanel2_jTextField1_actionAdapter(ArchivesPanel2 adaptee) {
        this.adaptee = adaptee;
    }
